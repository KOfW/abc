...
public interface HistoryAssessmentEmployeeRepository extends JpaRepository<AssessmentResult, Integer> {
    ...
    List<HistoryAssessmentEmployeeResponse> getAssessmentResultsWithDetails();
    ...
    List<HistoryAssessmentEmployeeResponse> getAssessmentResultsByUserId(@Param("userId") Long userId);
}
